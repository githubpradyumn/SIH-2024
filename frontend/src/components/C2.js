...
const C2 = () => {
  ...
  return (
    <div className="relative flex flex-col items-center w-full h-[calc(100vh-4rem)] overflow-hidden top-20">
      {isCam ? (
        <Web />
      ) : (
        <>
          <div className="bg-gray-500 flex flex-col w-full max-w-2xl rounded-lg p-4 h-96 overflow-y-auto">
